...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("jjsosa/ipinfo")
    client.subscribe("jjsosa/date")
    client.subscribe("jjsosa/time")
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("jjsosa/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("jjsosa/date", on_message_from_datenow)
    client.message_callback_add("jjsosa/time", on_message_from_timenow)
...
def on_message_from_datenow(client, userdata, message):
    print("Custom callback - Date " + message.payload.decode())

def on_message_from_timenow(client, userdata, message):
